...
const tabContent: TabContent[] = [
    ...
    {
        title: "TypeScript",
        description: "enhances our JavaScript development with static typing, catching errors early in the design-to-code process. Our agency uses it to ensure robust, scalable codebases for complex web applications, aligning technical precision with our creative vision.",
        icon: (
            <svg class="w-14 h-14 mx-auto" viewBox="0 0 128 128">
    ...
    {
        title: "CSS",
        description: "is our tool for bringing designs to life with precise styling and layouts. Our design agency uses it to craft visually stunning websites, ensuring pixel-perfect implementations of mockups with responsive designs that adapt seamlessly across devices.",
        icon: (
            <svg class="w-14 h-14 mx-auto" viewBox="0 0 128 128">
    ...
    {
        title: "HTML",
        description: "forms the structural backbone of our web projects. Our agency uses it to create semantic, accessible markup that supports our design systems, ensuring content is well-organized and optimized for both users and search engines.",
        icon: (
            <svg class="w-14 h-14 mx-auto" viewBox="0 0 128 128">
    ...
    {
        title: "Linux",
        description: "provides a stable, customizable environment for our development and deployment processes. Our agency relies on it for hosting design prototypes, running development servers, and automating workflows, ensuring efficiency and reliability.",
        icon: (
            <svg class="w-14 h-14 mx-auto" viewBox="0 0 128 128">
...
export default component$((props: Props) => {
    ...
    return (
        <section class="relative scroll-mt-16 max-w-5xl mx-auto" {...(id ? { id } : {})}>
            ...
            {/* SVG Grid */}
            <div class="grid grid-cols-3 lg:grid-cols-4 gap-0.25 -mx-0.5 md:gap-4 xl:gap-8 md:space-y-0 md:mb-8 md:mt-12">
