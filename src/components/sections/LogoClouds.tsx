...
export default component$((props: Props) => {
    ...
    return (
        <section class="relative scroll-mt-16 max-w-5xl mx-auto" {...(id ? { id } : {})}>
            <div
                class={twMerge(
                    "relative px-5 md:px-6 py-10 md:py-16 lg:py-20 text-default",
                    classes?.container,
                    isDark ? "dark" : ""
                )}
            >
...
// <div class="mt-6 grid grid-cols-3 lg:grid-cols-4 gap-2 md:gap-4 xl:gap-8 md:space-y-0 md:mb-8 md:mt-12">
// <a href="#" class="flex justify-center items-center p-2 md:p-8 text-center bg-background-accent rounded hover:bg-gray-200 dark:hover:bg-gray-700 dark:bg-gray-800">
//     <svg width={64} height={64} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128"></svg>
// </a>
// <a href="#" class="flex justify-center items-center p-2 md:p-8text-center bg-background-accent rounded hover:bg-gray-200 dark:hover:bg-gray-700 dark:bg-gray-800">
//     <svg width={64} height={64} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128"></svg>
// </a>
// <a href="#" class="flex justify-center items-center p-2 md:p-8 text-center bg-background-accent rounded hover:bg-gray-200 dark:hover:bg-gray-700 dark:bg-gray-800">
...
// </a>
// <a href="#" class="flex justify-center items-center p-2 md:p-8 md:p-8text-center bg-background-accent rounded hover:bg-gray-200 dark:hover:bg-gray-700 dark:bg-gray-800">
//     <svg width={64} height={64} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128"></svg>
// </a>
// <a href="#" class="flex justify-center items-center p-2 md:p-8 text-center bg-background-accent rounded hover:bg-gray-200 dark:hover:bg-gray-700 dark:bg-gray-800">
//     <svg width={64} height={64} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128"></svg>
...
// </a>
// <a href="#" class="flex justify-center items-center p-2 md:p-8 text-center bg-background-accent rounded hover:bg-gray-200 dark:hover:bg-gray-700 dark:bg-gray-800">
//     <svg width={64} height={64} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128"></svg>                    </a>
// <a href="#" class="flex justify-center items-center p-2 md:p-8 text-center bg-background-accent rounded hover:bg-gray-200 dark:hover:bg-gray-700 dark:bg-gray-800">
//     <svg width={64} height={64} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128"></svg>                    </a>
// <a href="#" class="flex justify-center items-center p-2 md:p-8 text-center bg-background-accent rounded hover:bg-gray-200 dark:hover:bg-gray-700 dark:bg-gray-800">
//     <svg width={64} height={64} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128"></svg>
