...
export default component$(() => {
  ...
  return (
    ...
    <section class="relative pb-2 px-0 border-2 border-gray-300 dark:border-gray-700 max-w-7xl mx-auto !h-[30vh] md:!h-[50vh] lg:!h-[50vh] xl:!h-[35vh] text-white overflow-hidden rounded-none">
