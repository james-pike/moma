...
export default component$(() => {
  ...
  return (
    <header
      id="header"
      class={`sticky top-0 z-40 bg-gradient-to-r from-primary-100 to-primary-50 flex-none mx-auto w-full border-b border-gray-200 transition-[opacity] ease-in-out ${
        store.isScrolling
