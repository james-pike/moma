...
const Root = component$<PropsOf<'div'>>((props) => {
  return (
    <div
      {...props}
      class={cn(
        'rounded-base border-2 dark:border-gray-700 bg-gray-200 border-gray-300 text-card-foreground shadow-sm',
        props.class,
      )}
    >
      <Slot />
...
const Header = component$<PropsOf<'div'>>((props) => {
  return (
    <div {...props} class={cn('flex flex-col space-y-1.5 p-0', props.class)}>
      <Slot />
    </div>
  );
});
...
const Content = component$<PropsOf<'div'>>((props) => {
  return (
    <div {...props} class={cn('py-0 px-0 bg-gray-200 border-2 dark:bg-gray-800 ', props.class)}>
      <Slot />
    </div>
  );
});
...
const Footer = component$<PropsOf<'div'>>(({ ...props }) => {
  return (
    <div {...props} class={cn('flex items-center p-0 pt-0', props.class)}>
      <Slot />
    </div>
  );
});
