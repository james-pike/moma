...
const Root = component$<PropsOf<'div'>>((props) => {
  return (
    <div
      {...props}
      class={cn(
        'rounded-base border-2 border-gray-300 dark:border-gray-700 dark:bg-gray-800 bg-gray-200 text-card-foreground shadow-sm',
        props.class,
      )}
    >
      <Slot />
...
const Content = component$<PropsOf<'div'>>((props) => {
  return (
    <div {...props} class={cn('p-3', props.class)}>
      <Slot />
    </div>
  );
});
